const strings = {
  website: "https://hu.pattern.monster",
  title: "Pattern Monster",
  description:
    "Egyszerű mintázat készítő, ismétlődő SVG ábrák létrehozásához.",
  description2: "Gyorsítsd fel a honlapodat miközben nem mondasz le a képminőségről.",
  description3: 
    "Tökéletes weboldal háttérekhez, ruházathoz, márka-, csomagolástervezéshez és még sok máshoz.",
  keywords:
    "svg mintázatok, mintázatok, svg hátterek, vektoros háttérkép, mintázat létrhozó, mintázat készítő",
  pages: [
    {
      page: "index",
      title: "SVG Minta készítő",
      keywords: "",
      description: "",
      image: "",
    },
    {
      page: "changelog",
      title: "Változás történet",
      keywords: "változás történet",
    ...
    },
    {
      ...
      keywords: "adatvédelmi irányelvek",
